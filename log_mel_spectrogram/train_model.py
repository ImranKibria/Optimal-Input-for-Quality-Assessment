'''This file trains CNN model for MOS prediction with feature vectors from audio mel spectrogram'''
...
dataset_dir = '/fs/scratch/PAS2301/Imran'
dataset_name = f'mel_spectrum_dataset/default'
(ds_train_sim, ds_train_live, ds_val_sim, ds_val_live), dataset_info = tfds.load(dataset_name, data_dir=dataset_dir,
...
with strategy.scope():
  ...
  model.compile(optimizer=tf.keras.optimizers.legacy.SGD(learning_rate=0.00001),  
